...
theme.font                                      = "Sauce Code Pro Nerd Font 12"
theme.taglist_font                              = "Sauce Code Pro Nerd Font 12"
...
theme.tasklist_fg_focus                         = "#ff5555"
...
local myweather = wibox.container.background(theme.weather.widget, theme.bg_focus, gears.shape.rectangle)
local myweathericon = wibox.container.background(weathericon, theme.bg_focus, gears.shape.rectangle)
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            spr_right,
            bar,
            wibox.container.margin(myweathericon, dpi(0), dpi(0), dpi(5), dpi(5)),
            wibox.container.margin(myweather, dpi(0), dpi(0), dpi(5), dpi(5)),
